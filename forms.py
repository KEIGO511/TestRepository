...
class UserInfoForm(FlaskForm):
    ...
    age = IntegerField('年齢：',validators=[NumberRange(min=18, max=100, message='入力範囲は18歳から100歳です')]
                       ,default=20)
    
    password = PasswordField('パスワード；',
                             validators=[Length(min=1, max=10, message='パスワードの長さは1文字以上10文字以内です'),
    ...
    birthday = DateField('生年月日：',
                         validators=[DataRequired('生年月日は入力必須です')],
                         format="%Y-%m-%d",
